...
"XLM": (XLMModel.from_pretrained('xlm-mlm-xnli15-1024',config=xlm_config, cache_dir='./pretrained_models',use_cdn = False).to(DEVICE), XLMTokenizer.from_pretrained('xlm-mlm-xnli15-1024'))
