# -*- coding: utf-8 -*-
"""IntroTransformers.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KSfZj-hhToMvH2K0ZOjHzfbUWdOm2brm
"""
import sys
...
def auto_regressive(model_info, curr_context, num_return_seqs, current_len, max_len, total_js):
  ...
  avg_distr = {x: (A.get(x, 0) + B.get(x, 0))//2 for x in set(A).union(B)}
