...
corr, p_value = pearsonr(cosine_scores, jsd_scores)

lr_model = LinearRegression()

slope, intercept = lr_model.fit(cosine_scores, jsd_scores)
...
plt.title("Pearson correlation score: " + corr + " and p-value: " + p_value)
plt.close()
